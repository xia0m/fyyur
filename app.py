...
def search_venues():
  ...
  query_result = Venue.query.filter(Venue.name.like(f"%{search_term}%")).all()
  response = {}
...
def search_artists():
  ...
  query_result = Artist.query.filter(Artist.name.like(f"%{search_term}%")).all()
  response = {}
  response['count'] = len(query_result)
  response['data'] = query_result
...
def edit_venue(venue_id):
  ...
  form.seeking_talent.default = "Yes" if venue_data.seeking_talent==True else "No"
...
def create_artist_submission():
  ...
  try:
    ...
    new_artist = Artist(name=artist_name,genres=genres,city=city,state=state,phone=phone,image_link=image_link,facebook_link=facebook_link,website=website,seeking_venue=seeking_venue,seeking_description=seeking_description)
